...
namespace Core_FirstProject.Areas.Writer.Models
{
    public class TurkishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError RecoveryCodeRedemptionFailed() { return new IdentityError { Code = nameof(RecoveryCodeRedemptionFailed), Description = "Kurtarma kodu kullanımı başarısız oldu." }; }
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars) { return new IdentityError { Code = nameof(PasswordRequiresUniqueChars), Description = $"Şifrede en az {uniqueChars} farklı karakter olmalıdır." }; }
